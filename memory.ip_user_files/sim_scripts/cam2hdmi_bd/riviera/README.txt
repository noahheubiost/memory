...
#
# Generated by export_simulation on Thu Nov 01 15:16:34 +0100 2018
#
################################################################################
...
'-reset_run' switch to the './cam2hdmi_bd.sh' script.

./cam2hdmi_bd.sh -reset_run
...
./cam2hdmi_bd.sh -noclean_files

For more information on the script, please type './cam2hdmi_bd.sh -help'.
