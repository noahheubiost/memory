...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "frameRate_g" -parent ${Page_0}
...
proc update_PARAM_VALUE.frameRate_g { PARAM_VALUE.frameRate_g } {
	# Procedure called to update frameRate_g when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.frameRate_g { PARAM_VALUE.frameRate_g } {
	# Procedure called to validate frameRate_g
	return true
}
...
proc update_MODELPARAM_VALUE.frameRate_g { MODELPARAM_VALUE.frameRate_g PARAM_VALUE.frameRate_g } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.frameRate_g}] ${MODELPARAM_VALUE.frameRate_g}
}
