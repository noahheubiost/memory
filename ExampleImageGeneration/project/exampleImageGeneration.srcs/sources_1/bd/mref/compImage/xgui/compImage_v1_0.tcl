...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "imSizeCompTotal_g" -parent ${Page_0}
...
proc update_PARAM_VALUE.imSizeCompTotal_g { PARAM_VALUE.imSizeCompTotal_g } {
	# Procedure called to update imSizeCompTotal_g when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.imSizeCompTotal_g { PARAM_VALUE.imSizeCompTotal_g } {
	# Procedure called to validate imSizeCompTotal_g
	return true
}
...
proc update_MODELPARAM_VALUE.imSizeCompTotal_g { MODELPARAM_VALUE.imSizeCompTotal_g PARAM_VALUE.imSizeCompTotal_g } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.imSizeCompTotal_g}] ${MODELPARAM_VALUE.imSizeCompTotal_g}
}
