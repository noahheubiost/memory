...
HD_PWD='C:/Users/nsheu/OneDrive/Desktop/miniprojekt/memory/memory.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cam2hdmi_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cam2hdmi_bd_wrapper.tcl
