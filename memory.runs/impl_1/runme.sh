...
HD_PWD='C:/Users/nsheu/OneDrive/Desktop/miniprojekt/memory/memory.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cam2hdmi_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cam2hdmi_bd_wrapper.tcl -notrace
