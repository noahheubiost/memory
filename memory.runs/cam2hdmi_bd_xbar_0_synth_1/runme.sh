...
HD_PWD='C:/Users/nsheu/OneDrive/Desktop/miniprojekt/memory/memory.runs/cam2hdmi_bd_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cam2hdmi_bd_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cam2hdmi_bd_xbar_0.tcl
